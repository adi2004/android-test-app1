 ...
 * 02.04.2014
 */
public class TestMethodNo4 implements LargestSquare {
	...
	public Mat editImage(Mat imageMat) {
		...
		this.squares = new ArrayList<java.awt.Point[]>();
	...
	private List<MatOfPoint> find_squares(Mat image) {
		...
		for (int l = 0; l < threshold_level; l++) {
			...
			// 
			System.out.println("Total number of contours is: " + contours.size());
	...
	public String toString() {
		...
		return name + " shows all squares, fails mid way";
	}
}
