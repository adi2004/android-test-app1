 ...
 * 02.04.2014
 */
public class OpenCVEditor implements LargestSquare {

	// If you get the UnsatisfiedLinkError on a x64-machine, change the OpenCV
	// native library location accordingly
	// under Project -> Properties -> Java Build Path -> Libraries -> Expand
	// opencv-248.jar -> ..\x86 or ..\x64
	...
	public Mat editImage(Mat imageMat) {
		...
		System.out.println("Edge detection finished. Used time: " + (System.currentTimeMillis() - time) + " ms");
		return imageMat;
	}
	...
	private void printSquare(MatOfPoint square, Mat image) {
		ArrayList<MatOfPoint> contours = new ArrayList<MatOfPoint>();
		// System.out.println("Coords of squares: " + square);
		contours.add(square);
		Imgproc.drawContours(image, contours, -1, new Scalar(255, 0, 0, 255), 8);
	}
	...
	public String toString() {
		return super.toString() + " original implementation";
	}
}
