...
public class ModifyExcel {
	...
	public void write() throws IOException, WriteException, BiffException {
		...
		Workbook rworkbook = Workbook.getWorkbook(file);
		WritableWorkbook workbook = Workbook.createWorkbook(new File("output.xls"), rworkbook);
	...
	private void createLabel(WritableSheet sheet) throws WriteException {
		...
		// Write a few headers
		addCaption(sheet, 0, 0, "Header 1213");
		addCaption(sheet, 1, 0, "This is another header123");
	...
	public static void main(String[] args) throws WriteException, IOException, BiffException {
		ModifyExcel test = new ModifyExcel();
