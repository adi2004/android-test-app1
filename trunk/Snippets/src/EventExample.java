...
public class EventExample {
	...
	// An interface implemented by the objects our listener wants to listen to
	...
	class DepositBox implements DepositBoxEventGenertor {
		...
		private ArrayList<DepositBoxChangedListener> depositBoxChangedListeners = new ArrayList<DepositBoxChangedListener>();
